    ...
    <ServiceCenterMainContainer className="myPageMainContainer">
        ...
        <HelpContContainer className="serviceCenterButton">
          ...
          <div className="myPageCheckContainer">
            ...
            <p><span className="textRedColor">예매번호</span>를 클릭하면 예매 상세 내용을 확인할 수 있습니다.<br/>
                공연/전시 예매 내역은 하단의 공연/전시 탭을 선택하면 확인할 수 있습니다.</p>
            ...
            <div className="sortbx">
              ...
              <p>예매한 내역이 확인이 안되실 경우 <a href="/" className="textRedColor">1:1 상담 문의</a>를 이용해주세요.</p>
              <table>
                <thead>
                  <tr>
                    <th>예매번호</th>
              ...
              <div>
                <div className="ticketGuideTableBody">
                  <h5>티켓취소 안내</h5>
                  <ol >
                    <li>예매한 티켓 전체 취소, 혹은 신용카드 결제 시 부분 취소가 가능합니다.
                        <br/>단, 일부 상품의 경우도 부분취소가 불가합니다.</li>
                    <li>티켓이 배송된 이후에는 인터넷이나 고객센터를 통한 취소가 불가하며, 받으신 티켓을 취소일 전까지 NHN LINK 본사로 반송을 해주셔야 취소 가능합니다. 
                      (등기우편을 이용해주세요!)</li>
                    <li>예매 당일 자정까지 취소하실 경우는 예매수수료도 환불되며, 취소수수료가 부과되지 않습니다. 
                      그 이후에 취소하실 경우는 예매수수료가 환불되지 않으며, 취소수수료는 정책에 따라 부과됩니다.</li>
                  </ol>
                </div>
              </div>
            </div>
